	...
	public static void main(String[] args) 
	{
		...
		for(int i = 0; i < 4; i++)
		{
			...
			while(true)
			{
				...
				if(Integer.parseInt(String.valueOf(posicaoBarcoInimigo[i].charAt(0))) > 8 || Integer.parseInt(String.valueOf(posicaoBarcoInimigo[i].charAt(1))) > 8)
					System.out.println("Posição inválida");
		...
		while(true)
		{
			...
			while(true)
			{
				...
				if(mapaInimigo[Integer.valueOf(String.valueOf(posicaoBomba1.charAt(0)))-1][Integer.valueOf(String.valueOf(posicaoBomba1.charAt(1)))-1] != null)
				{
			...
			while(true)
			{
				...
				if(mapa[Integer.valueOf(String.valueOf(posicaoBomba2.charAt(0)))-1][Integer.valueOf(String.valueOf(posicaoBomba2.charAt(1)))-1] != null)
				{
